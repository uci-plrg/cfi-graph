...
import edu.uci.plrg.cfi.x86.graph.data.graph.modular.metadata.EvaluationType;
...
public class ModuleDataWriter {
	...
	public void writeMetadataHistory(ModuleMetadata metadata,
			Map<edu.uci.plrg.cfi.x86.graph.data.graph.Edge<ModuleNode<?>>, Integer> edgeIndexMap) throws IOException {
